            ...
            <div className="container pt-4 gap-10 mx-auto flex flex-col md:flex-row">
                <div className=" md:w-1/2 ">
                    ...
                    <div className='pt-4  w-2/3 leading-8'>
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolorum non illum numquam nostrum dolorem deleniti. Sunt enim alias impedit iste, totam deleniti vitae, doloremque obcaecati maiores sapiente minus facilis neque.</p>
                    </div>
                    <div className='pt-4'>
                    ...
                    <Link to='/'>
                        <button className="btn btn-outline btn-info w-36 mt-6">
                            Back
                        </button>
                    </Link>
                </div>
